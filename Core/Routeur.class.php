...
class Routeur
{
	...
	public function __construct()
	{
		...
		(CB::my_assert($url[2])) ? Routeur::$url['controller'] = $url[2] : (isset($_SESSION['auth']) ? $this->redirect("Userindex/view") : $this->redirect("Authsignin/signIn"));
		(isset($url[3])) ? Routeur::$url['method'] = $url[3] : print_r("redirection 404");
